...
#Set Themes for ggplot2 - centers title and legend at bottom by default, also changes font size and background
theme_set(theme(plot.title = element_text(hjust = 0.5, size = 20),
